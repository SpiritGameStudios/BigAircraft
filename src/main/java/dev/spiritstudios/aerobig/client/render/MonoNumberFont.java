...
public record MonoNumberFont(ResourceLocation id, int spacing, int charWidth, int pointCharWidth, int textureWidth, int textureHeight) {
    ...
    public static MonoNumberFont create(ResourceLocation id, int charWidth, int pointCharWidth, int textureWidth, int textureHeight) {
        return create(id, 1, charWidth, pointCharWidth, textureWidth, textureHeight);
    }

    public static MonoNumberFont create(ResourceLocation id, int spacing, int charWidth, int pointCharWidth, int textureWidth, int textureHeight) {
        return new MonoNumberFont(id.withPrefix("textures/gui/").withSuffix(".png"), spacing, charWidth, pointCharWidth, textureWidth, textureHeight);
    }
