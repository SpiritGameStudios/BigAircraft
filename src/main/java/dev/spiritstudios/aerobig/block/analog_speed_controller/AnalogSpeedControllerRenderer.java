...
public class AnalogSpeedControllerRenderer extends SmartBlockEntityRenderer<AnalogSpeedControllerBlockEntity> {
    public AnalogSpeedControllerRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }
